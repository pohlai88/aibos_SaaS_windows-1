...
import { AccountingError } from '@aibos/core-types';
...
export class CustomerService {
  ...
  async createCustomer(
    ...
    customerData: Omit<CustomerInsert, 'id' | 'organization_id' | 'created_at' | 'updated_at'>
  ...
  async updateCustomer(
    organizationId: string,
    customerId: string,
    updates: Partial<Omit<CustomerInsert, 'id' | 'organization_id' | 'created_at' | 'updated_at'>>
  ): Promise<{ success: boolean; customer?: Customer; errors: AccountingError[] }> {
    const errors: AccountingError[] = [];
