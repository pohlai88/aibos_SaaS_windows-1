import React, {
import { Clock, Settings, TrendingUp, Star, Zap, Plus, Circle } from 'lucide-react';
 useState,
 useEffect,
 useRef,
 ReactNode,
...
export const Tabs: React.FC<TabsProps> = ({
 ...
 const _tabsRef = useRef<HTMLDivElement>(null);
...
export const TabAnalytics: React.FC<{
 ...
 const _sortedStats = Object.entries(usageStats);
...
export const _useAITabs = (
 ...
 const _updateUsage = useCallback((tabId: string) => {;
 setUsageStats((prev) => ({
 ...prev,
 [tabId]: {
 count: (prev[tabId]?.count || 0) + 1,
