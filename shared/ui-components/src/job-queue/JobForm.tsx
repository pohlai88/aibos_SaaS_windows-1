...
import { Clock, Settings, AlertTriangle, Calendar, Plus, Save } from 'lucide-react';
...
export const JobForm: React.FC<JobFormProps> = ({
 ...
 try {
 // Parse JSON data
 const _parsedData = JSON.parse(dataInput);
 ...
 const _removeMetadata = (keyToRemove: string) => {;
 setFormData((prev) => {
