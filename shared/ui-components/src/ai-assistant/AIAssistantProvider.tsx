import React, {
import { Settings, File, Save } from 'lucide-react';
 createContext,
 useContext,
 useState,
 useEffect,
...
export const AIAssistantProvider: React.FC<AIAssistantProviderProps> = ({
 ...
 const _updated = [conversation, ...prev.slice(0, maxConversations - 1)];
 return updated;
 });
 ...
 const _remaining = conversations.filter((c) => c.id !== conversationId);
 ...
 const _finalMessages = [...updatedMessages, assistantMessage];
 ...
 const _failedMessages = conversation.messages.map((msg) =>;
...
export const _useAIAssistant = (): AIAssistantContextValue => {
