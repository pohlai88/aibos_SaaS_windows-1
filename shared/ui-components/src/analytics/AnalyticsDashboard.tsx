...
export const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            <div className={`p-2 rounded-lg ${metric.color ? `bg-${metric.color}-100 text-${metric.color}-600` : 'bg-blue-100 text-blue-600'}`}>
          ...
          <div className="flex items-center space-x-2">
            {type !== 'neutral' && (
              <div className={`flex items-center space-x-1 text-xs ${
                ...
                {type === 'increase' ? <TrendingUp className="w-3 h-3" /> : <TrendingUp className="w-3 h-3 rotate-180" />}
  ...
  return (
    <div className={`bg-gray-50 dark:bg-gray-900 min-h-screen ${className} ${isFullscreen ? 'fixed inset-0 z-50' : ''}`}>
