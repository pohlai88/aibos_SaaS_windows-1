...
const FormBuilder: React.FC<FormBuilderProps> = ({;
 ...
 const _newValues = { ...values, [fieldId]: value };
 ...
 const _isFieldVisible = useCallback(;
 (field: FormField): boolean => {
 if (field.hidden) return false;
 if (field.dependsOn) {
 const _dependentValue = values[field.dependsOn];
 ...
 const _fieldError = errors[field.id];
 const commonProps = {;
 id: field.id,
 name: field.id,
 value: fieldValue,
 ...
 const _renderSection = (section: FormSection) => {;
 ...
 const _renderUnsectionedFields = () => {;
