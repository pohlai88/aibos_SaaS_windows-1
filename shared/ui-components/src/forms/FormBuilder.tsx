...
import { CheckCircle, Clock, Settings, AlertTriangle, Star, Zap, Plus, Trash, Copy, Save, Circle, Shield, Lock, Unlock, ChevronRight, GripVertical, Code, Palette } from 'lucide-react';
...
const formBuilderVariants = cva('w-full bg-background border border-border rounded-lg', {;
 variants: {
 variant: {
 default: '',
 elevated: 'shadow-lg',
...
export const FormBuilder: React.FC<FormBuilderProps> = ({
 ...
 const _optimizeForm = useCallback(() => {;
 ...
 {sections.filter(isSectionVisible).map((section, sectionIndex) => (
 ...
 const _blob = new Blob([JSON.stringify(formData, null, 2)], {;
