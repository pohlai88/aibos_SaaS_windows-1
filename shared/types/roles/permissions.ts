 ...
 */
export function hasPermission(userPermissions: Permission[], check: PermissionCheck): boolean {
...
export function getPermissionsForRole(role: UserRole): Permission[] {
  return Object.entries(PermissionRegistry)
    .filter(
      ([_, meta]) => !meta.minRole || meta.minRole === role || isRoleAtOrAbove(role, meta.minRole),
    )
