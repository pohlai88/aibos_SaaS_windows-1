...
export type MetadataErrorCategory = typeof MetadataErrorCategory[keyof typeof MetadataErrorCategory];
...
export type MetadataErrorRecoveryStrategy = typeof MetadataErrorRecoveryStrategy[keyof typeof MetadataErrorRecoveryStrategy];
...
export interface MetadataErrorRecoveryManager {
  ...
  circuitBreaker<T>(operation: () => Promise<T>, options?: {
...
export class MetadataErrorUtils {
   ...
   */
  static groupErrorsByCategory(errors: MetadataError[]): Record<MetadataErrorCategory, MetadataError[]> {
   ...
   */
  private static mapSeverityToBusinessImpact(severity: MetadataErrorSeverity): 'low' | 'medium' | 'high' | 'critical' {
    switch (severity) {
      case 'low':
        return 'low';
      case 'medium':
